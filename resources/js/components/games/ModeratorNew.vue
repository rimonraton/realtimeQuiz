                ...
                <div class="card my-4" v-for="question in questions" v-if="question.id == current">
                    <div class="card-body animate__animated animate__backInRight animate__faster position-relative">
                      ...
                      <Transition name="fade" >
                        ...
                        <div>
                            <div v-if="endAVWait">
                                <video v-if="question.fileType == 'video'" :src="'/'+ question.question_file_link" @error="audioVideoError()" @ended="onEnd()" @play="onStart()" class="image w-100 mt-1 rounded img-thumbnail" controls="controls" playsinline autoplay>
                                    <!--                                    <source :src="'/'+ question.question_file_link" @error="audioVideoError()" type="video/mp4">-->
                                </video>
                                <div class="audio" v-if="question.fileType == 'audio'">
                                    <audio :src="'/'+ question.question_file_link" @error="audioVideoError()" @ended="onEnd()" @play="onStart()" controls autoplay />
                                    <div id="ar"></div>
                                </div>
                            </div>
                            <div v-else>
                                ...
                                <div v-if="sqo"
                                    ...
                                    <div v-else v-for="(option, i) in question.options" class="col-md-6 px-1" :class="[option.flag == 'img' ? 'col-6' : 'col-12' ]">
                                        ...
                                        <div v-else @click="checkAnswer(question.id, option.img_link, option.correct)"
                                             class="cursor my-2 text-center " :class="getOptionClass(i, challenge.option_view_time)">
