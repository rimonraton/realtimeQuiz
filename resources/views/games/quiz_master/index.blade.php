...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                @if(Permission::can('game.quizMaster.create'))
                <a type="button" class="btn btn-info btn-rounded float-right" href="{{route('game.quizMaster.create')}}" >
                    {{__('form.create_quiz')}}
                </a>
                @endif
...
{{--                                <a class="btn btn-outline-purple" href=""><i class="fas fa-share-alt"></i> {{ __('msg.share') }}</a>--}}
                                ...
                                <a class="btn btn-outline-inverse"
                                   href="{{route('game.quizMaster.start',['quiz' =>$q->id, 'user' =>auth()->user()->id])}}">
                                    {{__('msg.start')}}
                                </a>
                                @endif
                            </div>
