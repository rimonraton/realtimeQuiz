...
<main id="main">
    ...
    <section id="about" class="about">
        <div class="container-fluid">
            ...
            <div class="container">
                <h3 class="mb-3 text-center">{{$challenge->name}} Result</h3>
                <div class="row mb-5">
                        ...
                        <ul class="list-group ">
                            @foreach($sr as $s)
                                <li class="list-group-item d-flex justify-content-between">
                                    ...
                                    <span>{{ $s->name }} </span>
                                    <span>
                                        @if($loop->iteration == 1)<i class="fas fa-award fa-lg" style="color: gold"></i> @endif
                                        @if($loop->iteration == 2)<i class="fas fa-award" style="color: silver"></i> @endif
                                        @if($loop->iteration == 3)<i class="fas fa-award fa-sm" style="color: #CD7F32"></i> @endif
                                        {{ $s->score .' / '. $challenge->quantity * 100}}
                                    </span>
                    ...
                    <div class="col-6">
                        <img class="card-img img-responsive" src="{{url('challengeShareResult/'.$link)}}" type="image/png" >
                    </div>
                </div>
            </div>
