            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title text-center">
                        {{__('msg.createquiz')}}
                        <a class="btn btn-success waves-effect waves-light text-white float-right" href="{{url('quizPractice')}}">
                            {{__('form.goto_quiz_list')}}
                        </a>
                    </h4>
                    <hr>
                    <form class="form-horizontal r-separator" action="{{url('quizPracticeSave')}}" method="POST" autocomplete="off">
                        @csrf
